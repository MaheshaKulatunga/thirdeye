...
""" Model 1 Basic 3DCNN for MV"""
def sixthsense(xtrain_raw, ytrain,summary=False, frame_clip=-1):
    ...
    if frame_clip != -1:
        ...
        xtrain = xtrain_raw.reshape((len(xtrain_raw), 19, 100, 100, 1))
        input_layer = Input((19, 100, 100, 1))
